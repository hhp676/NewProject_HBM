	    	...
	    	<div class="row">
	    		<div class="col-xs-3">
 					<div class="input-group">
	                	<span class="input-group-addon"><div style="width:55px;">执行器</div></span>
	            ...
	            <div class="col-xs-3">
	              	<div class="input-group">
	                	<span class="input-group-addon"><div style="width:55px;">任务</div></span>
          	...
          	<div class="row">
	    		<div class="col-xs-3">
 					<div class="input-group">
	                	<span class="input-group-addon"><div style="width:55px;">调度结果</div></span>
                		<select class="form-control" id="triggerCode"  paramVal="<#if jobInfo?exists>${jobInfo.jobGroup}</#if>" >
	            ...
	            <div class="col-xs-3">
	              	<div class="input-group">
	                	<span class="input-group-addon"><div style="width:55px;">执行结果</div></span>
                        <select class="form-control" id="handleCode" paramVal="<#if jobInfo?exists>${jobInfo.id}</#if>" >
                            <option value="" >全部</option>
                            <option value="200" >成功</option>
                            <option value="500" >失败</option>
						</select>
