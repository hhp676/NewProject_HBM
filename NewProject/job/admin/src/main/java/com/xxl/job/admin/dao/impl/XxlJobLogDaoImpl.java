...
public class XxlJobLogDaoImpl implements IXxlJobLogDao {
	...
	@Override
	public List<XxlJobLog> pageList(int offset, int pagesize, int jobGroup, int jobId, String triggerCode, String handleCode, Date triggerTimeStart, Date triggerTimeEnd) {
	...
	@Override
	public int pageListCount(int offset, int pagesize, int jobGroup, int jobId, String triggerCode, String handleCode, Date triggerTimeStart, Date triggerTimeEnd) {
		HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("offset", offset);
		params.put("pagesize", pagesize);
		params.put("jobGroup", jobGroup);
