...
public class JobLogController {
	...
	public Map<String, Object> pageList(@RequestParam(required = false, defaultValue = "0") int start,  
			...
			int jobGroup, int jobId, String filterTime, String triggerCode, String handleCode) {
		...
		// page query
		List<XxlJobLog> list = xxlJobLogDao.pageList(start, length, jobGroup, jobId, triggerCode, handleCode, triggerTimeStart, triggerTimeEnd);
		int list_count = xxlJobLogDao.pageListCount(start, length, jobGroup, jobId, triggerCode, handleCode, triggerTimeStart, triggerTimeEnd);
