...
public class ActionEnter {
    ...
    /**
     * 
     * Creates a new instance of ActionEnter.
     *
    ...
    public String invoke() {
        ...
        switch (actionCode) {
            ...
            case 4:
                ...
                conf.put("useFtpUpload",
                    this.configManager.getAllConfig().getString("useFtpUpload"));
                conf.put("keepLocalFile",
                    this.configManager.getAllConfig().getString("keepLocalFile"));
