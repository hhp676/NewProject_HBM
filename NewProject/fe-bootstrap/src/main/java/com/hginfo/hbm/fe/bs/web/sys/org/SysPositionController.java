...
public class SysPositionController {
    ...
    */
     ...
     * @since V1.0.0
     */
    private List<ComboTreeModel> getSubPosList(Long currPosID, Long fID,
        List<SysPosition> posList) {
    ...
    @ResponseBody
    public Page<SysPosition> posList(SysPosition filter, BasePage<SysPosition> basePage,
