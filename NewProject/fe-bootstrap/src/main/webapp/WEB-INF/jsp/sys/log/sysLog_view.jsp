...
<body>
<div class="easyui-layout easyui-datagrid-layout" fit=true id="sysLog_layout">
<div data-options="region:'center',title:'日志列表',border:false" style="padding: 0px;">
    ...
    <div id="sysLog_toolbar" tag=listen_hotkey>
				<div class="hgGridSearchBar"
					style="height: 32px; width: 100%;display:block;" tag="queryDiv">
					<form id="sysLogSearchForm">
						<table  width="100%">
							<tr>
								...
								<td><input name="keyword" style="width: 100px;" class="easyui-textbox"></td>
