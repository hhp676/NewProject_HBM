        ...
        <div data-options="region:'center'" style="padding: 10 10 10 20px;">
            <form id="sysAuth_form" class="hgform">
                ...
                <table class="hgtable">
                    ...
                    <tr height="30px;">
                        <td width="50px;"></td>
                        <td width="100px;" align="right">模块<sup>*</sup>：</td>
                        <td width="250px;">
                    ...
                    <tr height="30px;">
                        <td></td>
                    	<td width="100px;" align="right">权限名称<sup>*</sup>：</td>
                    ...
                    <tr height="30px;">
                        <td></td>
                        <td align="right">操作类型<sup>*</sup>：</td>
                        <td>
                    ...
                    <tr height="30px;">
                        ...
                        <td>
                            <a class="btn btn-default btn-xs shiny icon-only" href="javascript:void(0);" tag="choose"><i class="${authObj.bsStyle}"></i></a>
                            <input type="hidden" name="bsStyle" style="width: 200px" value="${authObj.bsStyle}"></input>
                        </td>
                        <%-- <td>图标：</td>
