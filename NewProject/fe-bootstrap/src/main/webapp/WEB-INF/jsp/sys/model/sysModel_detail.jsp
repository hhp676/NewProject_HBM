            ...
            <form id="sysModel_form" class="hgform">
                ...
                <table class="hgtable">
                    ...
                    <tr height="30px;">
                        ...
                        <td>
                            <a class="btn btn-default btn-xs shiny icon-only" href="javascript:void(0);" tag="choose"><i class="${modelObj.bsStyle}"></i></a>
                    ...
                    <tr height="30px;">
                        ...
                        <td colspan="3">
                            <textarea name="descr" multiline="true"  
                                style="height:50px;width:555px;" >${modelObj.descr}</textarea>
                        </td>
                    </tr>
