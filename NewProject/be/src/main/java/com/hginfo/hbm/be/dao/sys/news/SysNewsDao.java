...
import com.hginfo.hbm.be.mapper.sys.news.SysNewsMapper;
 ...
 */
@Repository
public class SysNewsDao extends SingleKeyBaseDao<SysNews>
        implements SysNewsMapper {
