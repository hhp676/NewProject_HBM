...
public class SysFileController {
     ...
     *
     */
    private static final Log    LOG  = LogFactory.getLog(SysFileController.class);
    /**
     *
     */
    ...
    @ResponseBody
    public Page<SysAttachment> fileList(BasePage<SysAttachment> pageInfo, SysAttachment formFilter) {
        SysAttachment filter = new SysAttachment();
        pageInfo.parseFilterRules(filter);
        pageInfo.parseSortRule(filter);
        Page<SysAttachment> page = new Page<>(attachmentService.getPageList(pageInfo, filter, "sysFile"));
        return page;
    }
    ...
    public void downFile(@PathVariable long fileId, @PathVariable long attId, HttpServletRequest request,
