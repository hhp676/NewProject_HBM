...
public class SysOrganizationController {
     ...
     * @since V1.0.0
     */
    private List<ComboTreeModel> getSubOrgList(Long currOrgID, Long fID, List<SysOrganization> orgList) {
    ...
    private static final class NodeLinker {
        ...
        private void linkParent(SysPosition pos) {
            ...
            linkParent(pos.getFid() != null ? fetchPos(pos.getFid()) : fetchOrg(pos.getOrgId()),
                    nodeMap.get(pos.getId()));
        }
