...
(function(){
		...
		sysUserGrid.toolbar.find("[tag=submit]").click(function(){
			var searchData = {};
			searchData["userNameForQuery"] =  $.trim(sysUserGrid.toolbar.find("[name=userName]").val());
			searchData["emailForQuery"] =  $.trim(sysUserGrid.toolbar.find("[name=email]").val());
			searchData["staffInfo.staffCode"] =  $.trim(sysUserGrid.toolbar.find("[name=staffCode]").val());
			searchData["staffInfo.staffStatus"] =  $.trim(sysUserGrid.toolbar.find("[name=staffStatus]").val());
			searchData["staffInfo.startTimeStr"] =  $.trim(sysUserGrid.toolbar.find("[name=startTime]").val());
			searchData["staffInfo.endTimeStr"] =  $.trim(sysUserGrid.toolbar.find("[name=endTime]").val());
			searchData["userAccount.loginName"] =  $.trim(sysUserGrid.toolbar.find("[name=loginName]").val());
			searchData["userPosition.positionName"] = $.trim(sysUserGrid.toolbar.find("[name=positionName]").val());
			
			searchData["userPosition.sysJob.jobName"] = $.trim(sysUserGrid.toolbar.find("[name=jobName]").val());
			searchData["userPosition.sysOrganization.orgName"] = $.trim(sysUserGrid.toolbar.find("[name=orgName]").val());
...
//员工状态combobox
sysUserGrid.toolbar.find("#staffStatus").combobox({  
	panelHeight:'auto',
	editable:false,
	textField:'text',
	valueField:'value',    
