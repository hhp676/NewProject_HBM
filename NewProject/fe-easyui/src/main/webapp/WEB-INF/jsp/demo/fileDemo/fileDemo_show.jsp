	                ...
	                <tr>
	                   <td>
	                    <a class="easyui-linkbutton" iconCls="icon_auto_colorful__plus" 
	                        onclick="singleUpload();">单附件上传</a>
	                    <a class="easyui-linkbutton" iconCls="icon_auto_colorful__plus" 
	                        onclick="filesUploadDemo();">多附件上传</a>
	                    <a class="easyui-linkbutton" iconCls="icon_auto_colorful__plus" 
	                        onclick="relationFileUploadDemo();">关联上传</a>
	                    <a class="easyui-linkbutton" iconCls="icon_auto_colorful__plus" 
	                        onclick="webUploadDemo();">webupload上传</a>
	                   </td>
	                </tr>
	            </table>
            </fieldset>
                    ...
                    <tr>
                        ...
                        <td style="position: position: relative;cursor: pointer;">
                            <div style="float: left;">
                                <input id="fileText" value="请选择上传文件" style="height: 20px;" disabled>
                            </div>
            ...
            <fieldset style="width: 920px;height: 80px;">
                ...
                <table>
                    <tr>
                        ...
                        <td align="left">
                            <a class="easyui-linkbutton" iconCls="icon_auto_colorful__download" 
                                 onclick="downLoadFile();">文件下载demo</a>
                        </td>
                    </tr>
                </table>
            </fieldset>
