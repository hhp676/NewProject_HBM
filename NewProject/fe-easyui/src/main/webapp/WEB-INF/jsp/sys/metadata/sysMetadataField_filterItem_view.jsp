...
<body>
    <table singleSelect=true fit=true id="sysMetadataField_filterItem_grid" class="easyui-datagrid"
	...
	<script type="text/javascript" src="${ctx}/static/js/sys/metadata/sysMetadataField_filterItem_view.js?jsTimer=${jsTimer}"></script>
</body>
