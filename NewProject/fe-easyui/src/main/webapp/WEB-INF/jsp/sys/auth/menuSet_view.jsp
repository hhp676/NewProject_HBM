            ...
            <table fit=true id="menu_grid" class="easyui-treegrid"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'isTopMenu',width:10,formatter:function(value){return HgUtil.getDictItemName('trueOrFalse',value);},editor:{type:'combobox',options:{data:logicMap,textField:'itemName',
                            valueField:'itemValue',editable:false,panelHeight:'auto'}}">顶部菜单</th>
                        <th data-options="field:'isSubMenu',width:10,formatter:function(value){return HgUtil.getDictItemName('trueOrFalse',value);},editor:{type:'combobox',options:{data:logicMap,textField:'itemName',
                    ...
                    <form id="menusetSearchForm">
                        <table width="100%">
                            <tr>
                                ...
                                <td width="130px"><input style="width: 130px"
                                    name="authName" id="menusetSearchAuthName" class="easyui-textbox"></td>
                                ...
                                <td width="130px" style="padding-left: 20px"><a
                                    class="easyui-linkbutton" iconCls="icon-search"
                                    onclick="sysMenuSet._search();">查询</a> </select> <a class="easyui-linkbutton"
                                    iconCls="icon_clear" onclick="sysMenuSet._clear();">清空</a></td>
                            </tr>
                        </table>
                    </form>
                </div>
