			...
			<h:hasAnyPermissions
				...
				<div data-options="region:'north',border:false"
					...
					<h:hasAllPermissions name="<%=Auths.Sys.USER_UPDATE%>">
						<a class="easyui-linkbutton" iconCls="icon_auto_colorful__editor" plain="true"
							onclick="sysUserDetail.toEdit()">修改</a>
					</h:hasAllPermissions>
					<h:hasAllPermissions name="<%=Auths.Sys.USER_DELETE%>">
						<a class="easyui-linkbutton" iconCls="icon_delete" plain="true"
							onclick="sysUserDetail.toDel()">删除</a>
					</h:hasAllPermissions>
				</div>
			</h:hasAnyPermissions>
		</c:if>
		<div data-options="region:'center'" style="padding: 10 10 10 20px;">
			<div class="easyui-layout" fit=true data-options="border:false">
				<div data-options="region:'center',border:false">
					<div class="easyui-layout" fit=true data-options="border:false">
						<div data-options="region:'north',border:false"
							style="height: 110px; padding-top: 5px;" title="登录信息"
							collapsible=false>
							<form id="userAccountForm" class="hgform">
								<table class="hgtable">
									<tr>
										<td style="width: 78px;" align="right">登录名<font>*</font>：
										</td>
									...
									<tr>
										...
										<td colspan="3"><textarea name="descr" cols=80 rows=3
												${mode == 'view'?'disabled':''}
												style="width: 365px; height: 30px;">${user.userAccount.descr}</textarea><br />
										</td>
									</tr>
								</table>
							</form>
						...
						<div data-options="region:'center'" title="用户信息"
							...
							<form id="userInfoForm" class="hgform">
								<table class="hgtable">
									<tr>
										<td style="width: 78px;" align="right">用户名<font>*</font>：
										</td>
										<td style="width: 170px;"><input type="text"
											name="userName" value="${user.userName}"
											${mode == 'view'?'disabled':''} style="width: 140px;" /><br />
										</td>
										<td align="right">英文名：</td>
										<td style="width: 170px;"><input name="engName"
											value="${user.engName}" ${mode == 'view'?'disabled':''}
											style="width: 138px;" /><br /></td>
									</tr>
									<tr>
										<td align="right">性别<font>*</font>：
										</td>
									...
									<tr>
										...
										<td style="width: 170px;"><input name="telephone"
											...
											value="${user.telephone}" style="width: 138px;" /><br /></td>
									</tr>
									<tr>
										<td align="right">邮箱：</td>
										<td colspan="3"><input name="email"
											${mode == 'view'?'disabled':''} value="${user.email}"
											style="width: 372px;" /><br /> <label for="idCard"></label>
										</td>
									</tr>
									<tr>
										...
										<td colspan="3"><input name="address"
											...
											style="width: 372px;" /><br /></td>
									</tr>
									<tr>
										<td align="right">描述：</td>
										<td colspan="3"><textarea name="descr" cols=80 rows=3
												${mode == 'view'?'disabled':''}
												style="width: 363px; height: 30px;">${user.descr}</textarea><br />
										</td>
									</tr>
								</table>
							</form>
								...
								<table class="hgtable">
									...
									<tr>
										...
										<td><input name="bankCard"
											${mode == 'view'?'disabled':''}
											value="${user.staffInfo.bankCard}" style="width: 130px;" /><br />
											<label for="bankCard"></label></td>
									</tr>
									<tr>
										<td align="right">描述：</td>
										<td colspan="3"><textarea name="descr" cols=80 rows=3
												${mode == 'view'?'disabled':''}
												style="width: 365px; height: 30px;">${user.staffInfo.descr}</textarea><br />
										</td>
									</tr>
								</table>
							</form>
						...
						<div title="权限信息">
							<table style="width: 100%" id="sysAuthManage_grid_userAuth_table">
								<tr>
									...
									<td width="30%"><input id="authName"></td>
									<td width="65px"><a href="javascript:void(0)" class="easyui-linkbutton"
										iconCls="icon-search"
										onclick="sysAuthManage_grid_userAuth.searchStr();">定位</a></td>
									<td id="treeGridShowNext"><a href="javascript:void(0)"
										class="easyui-linkbutton" iconCls="icon_auto_colorful__down"
										onclick="sysAuthManage_grid_userAuth.showNext();">下一个</a></td>
								</tr>
							</table>
							<c:if test="${mode != 'view'}">
						...
						<div title="负权限信息">
							<table style="width: 100%"
								...
								<tr>
									...
									<td width="65px"><a href="javascript:void(0)" class="easyui-linkbutton"
										iconCls="icon-search"
										onclick="sysAuthManage_grid_userNAuth.searchStr();">定位</a></td>
									<td id="treeGridShowNext"><a href="javascript:void(0)"
										class="easyui-linkbutton" iconCls="icon_auto_colorful__down"
										onclick="sysAuthManage_grid_userNAuth.showNext();">下一个</a></td>
								</tr>
							</table>
							<c:if test="${mode != 'view'}">
