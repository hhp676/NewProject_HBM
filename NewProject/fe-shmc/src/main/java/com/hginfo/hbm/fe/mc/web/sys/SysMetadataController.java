...
public class SysMetadataController {
    ...
    */
    ...
    public Page<SysMetadataEntity> getEntityList(SysMetadataEntity filter) {
        ...
        page.setTotal(entityList == null ? 0 : entityList.size());
        return page;
    }
    ...
    public Page<MetaTable> metaTableList() {
        ...
        page.setTotal(tableList == null ? 0 : tableList.size());
        return page;
    }
    ...
    @ResponseBody
    public Page<SysMetadataField> fieldList(@PathVariable long entityId, BasePage<SysMetadataField> pageInfo) {
    ...
    @ResponseBody
    public List<SysMetadataField> getFieldList(@PathVariable long entityId, @PathVariable long filterTypeId) {
        SysMetadataField filter = new SysMetadataField();
        filter.setEntityId(entityId);
