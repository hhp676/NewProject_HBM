	    ...
	    case "themeColor":
	    	$("#sysUserProfile_grid").datagrid('addEditor',[{
				field:'profileValue',editor:{
				    type:'combobox',
				    options:{
				    	panelHeight:'auto',url: G_CTX_PATH + '/sys/common/sysDict/itemList/mcColorList',
