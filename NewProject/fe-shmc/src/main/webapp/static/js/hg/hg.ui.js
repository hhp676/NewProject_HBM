...
(function(){
	...
	HgUi.ok = function(msg, callback) {
		...
		okMsg.append("<div class='messager-icon messager-info'></div>");
        okMsg.append("<div>" + msg + "</div>");
		$.messager.alert({
			title:"提示",
			msg:okMsg.toString(),
			icon:null,
	...
	HgUi.error = function(msg, callback) {
		var okMsg = new StringBuffer();
		okMsg.append("<div class='messager-icon messager-error'></div>");
        okMsg.append("<div>" + msg + "</div>");
		$.messager.alert({
			title:"错误",
			msg:okMsg.toString(),
	...
	HgUi.notice = function (msg, callback) {
        var okMsg = new StringBuffer();
        okMsg.append("<div class='messager-icon messager-warning'></div>");
        okMsg.append("<div>" + msg + "</div>");
		$.messager.alert({
			title:"通知",
			msg:okMsg.toString(),
	...
	HgUi.hideShowSearch = function(thisClickObj){
		if ($(thisClickObj).hasClass('slide_up')) {
			$(thisClickObj).parent().parent().next().addClass("hide");
			$(thisClickObj).removeClass();
			$(thisClickObj).addClass("slide_down");
		} else {
			$(thisClickObj).parent().parent().next().removeClass("hide");
			$(thisClickObj).removeClass();
			$(thisClickObj).addClass("slide_up");
