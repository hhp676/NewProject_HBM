...
<body>
<style>
#chooseIconView_layout{
    padding:5px;
}
#chooseIconView_layout h4{
    height: 32px;
    line-height: 32px;
    text-indent: 1em;
    font-weight: bold;
...
#chooseIconView_layout section{
    clear: both;
}
</style>
    <div class="easyui-layout" data-options="fit:false" id="chooseIconView_layout">
            <div id="fontawesome-container">
            <span class="input-icon" style="position: relative;    margin-left: 10px;">
                                    <input type="text" class="form-control" id="fontawsome-search" placeholder="Search" style="padding-left:18px;">
                                    <i class="fa fa-search" style="position: absolute;left: 5px;top: 2px;"></i>
                                </span>
                                    <div class="fa-hover " style="float:right;margin-right:5px;">
                                                <a href="javascript:void(0);" class="a_btn_red"><i class=""></i><em>清空图标</em></a>
                                            </div>
                                        <section id="new">
                                        <h4>
                                        40 New Icons in 4.3</h4>
    ...
    $("#chooseIconView_layout .fa-hover").click(function(){
    	var icon = {
    		iconCss:$(this).find("i").attr("class")
    	};
        ...
        $("#fontawsome-search")
            .keyup(function () {
                ...
                if (term === "") {
                    $(".fa-hover")
                        .show();
                    $('#fontawesome-container .alert')
                        .parent()
                        .show();
                    $('#fontawesome-container section')
                        .each(function () {
                            $(this)
                                .css('display', 'block');
                        });
